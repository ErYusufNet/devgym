...
export function IconBrandGithub({ className = "w-5 h-5" }) {
  return (
    <svg {...base} className={className}>
...
export function IconSchool({ className = "w-5 h-5" }) {
  return (
    <svg {...base} className={className}>
...
export function IconHeartHandshake({ className = "w-5 h-5" }) {
  return (
    <svg {...base} className={className}>
...
export function IconBrandX({ className = "w-5 h-5" }) {
  return (
    <svg {...base} className={className}>
...
export function IconBrandLinkedin({ className = "w-5 h-5" }) {
  return (
    <svg {...base} className={className}>
      <path d="M8 11v5" />
      <path d="M8 8v.01" />
...
export function IconStarFilled({ className = "w-5 h-5" }) {
  return (
